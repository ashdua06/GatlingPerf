...
public class PropertyUtils {
    ...
    public void emptyPropertyFile(String filePath){
        try {
            File propertyFile = new File(System.getProperty("user.dir") + filePath);
    ...
    public void store(String fileName){
        try {
            ...
            System.out.println("channel is "+out.getChannel());
